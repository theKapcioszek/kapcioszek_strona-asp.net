...
{
    public class album_undefinedModel : PageModel
    {
        ...
        public album_undefinedModel() {
            ...
            try
            {
                ...
                string sql = "SELECT ID FROM utwor WHERE album = 1";
        ...
        public void OnGet()
        {
            ...
            try
            {
                ...
                string sql = "SELECT name, link FROM utwor WHERE album = 1";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
                MySqlDataReader rdr = cmd.ExecuteReader();
